...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-dark-red"><?php echo e(__('Đăng ký')); ?></div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Username -->
                        <div class="row mb-3">
                            <label for="username" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Tên đăng nhập')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Số điện thoại -->
                        <div class="row mb-3">
                            <label for="phone" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Số điện thoại')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Thành phố -->
                        <div class="row mb-3">
                            <label for="city" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Thành phố')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Quận/Huyện -->
                        <div class="row mb-3">
                            <label for="district" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Quận/Huyện')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="district" value="<?php echo e(old('district')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!-- Phường/Xã -->
                        <div class="row mb-3">
                            <label for="ward" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Phường/Xã')); ?></label>

                            <div class="col-md-6">
                                <input id="ward" type="text" class="form-control <?php $__errorArgs = ['ward'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="ward" value="<?php echo e(old('ward')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="card-footer text-center">
                    <p>Bạn đã có tài khoản? <a href="<?php echo e(route('login')); ?>">Đăng nhập</a></p>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('ui.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\BTL_Web\perfume-celling-app\resources\views/ui/auth/register.blade.php ENDPATH**/ ?>
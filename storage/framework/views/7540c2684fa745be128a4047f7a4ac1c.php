            ...
            <div class="nav">
                ...
                <div>
                    ...
                    <div class="collapse" id="collapseAdmin" aria-labelledby="headingO" data-bs-parent="#sidenavAccordion">
                        ...
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="<?php echo e(route('admin.register')); ?>">Thêm mới</a>
                        </nav>
                    </div>
                </div>
                ...
                <div class="collapse" id="collapseOrder" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                        <a class="nav-link" href="<?php echo e(route('admin.orders.index')); ?>" style="margin-left: 0">Quản lý</a>
                    </nav>
                </div>
                <!-- quản lý giao diện -->

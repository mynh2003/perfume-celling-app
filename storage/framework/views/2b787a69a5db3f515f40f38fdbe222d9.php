...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card my-5">
            <div class="card-header bg-dark"><?php echo e(__('Đăng ký tài khoản hệ thống')); ?></div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        <label for="password-confirm" class="form-label"><?php echo e(__('Nhập lại mật khẩu')); ?></label>
                        <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required>
                    </div>

                    <div class="mt-4">
                        <button type="submit" class="btn btn-primary w-100"><?php echo e(__('Đăng ký')); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\BTL_Web\perfume-celling-app\resources\views/admin/auth/register.blade.php ENDPATH**/ ?>
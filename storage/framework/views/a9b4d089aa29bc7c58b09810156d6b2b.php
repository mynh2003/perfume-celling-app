    ...
    <div class="mainmenu-mobile">
        ...
        <ul class="mainmenu">
            <li>
                    <?php if(auth()->guard()->guest()): ?>
                        <?php if(Route::has('login')): ?>
                                <a class="dropdown-toggle-user" href="<?php echo e(route('login')); ?>"><?php echo e(__('ĐĂNG NHẬP')); ?></a>
                        <?php endif; ?>
                    <?php else: ?>
                        ...
                        <ul class="submenu list-unstyled">
                            <li><a href="<?php echo e(route('user.profile')); ?>"><?php echo e(__('Thông tin')); ?></a></li>
                            <li><a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><?php echo e(__('Đăng xuất')); ?></a></li>                          
                            <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" class="d-none">
                                <?php echo csrf_field(); ?>
                            </form>
                        </ul>
            ...
            <li><a href="<?php echo e(route('orders.history')); ?>" class="history-link">LỊCH SỬ ĐƠN HÀNG</a></li>
            <li>
                <a href="#" class="dropdown-toggle">DANH MỤC</a>
                <ul class="submenu list-unstyled">
                    <li><a href="<?php echo e(route('pages.products')); ?>">Sản phẩm</a></li>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        <a href="<?php echo e(route('product.productWithCategory', ['category_id' => $category->id])); ?>">
...
<?php /**PATH E:\Project\BTL_Web\perfume-celling-app\resources\views/ui/layouts/header.blade.php ENDPATH**/ ?>
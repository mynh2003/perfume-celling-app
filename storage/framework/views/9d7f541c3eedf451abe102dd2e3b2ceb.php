            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a id="addToCartLink" href="javascript:void(0)" class="btn btn-primary" onclick="<?php echo e(Auth::check() ? '' : 'notifyLogin()'); ?>">Thêm giỏ hàng</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\BTL_Web\perfume-celling-app\resources\views/pages/products.blade.php ENDPATH**/ ?>
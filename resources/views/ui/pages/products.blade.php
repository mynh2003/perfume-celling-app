    ...
    <div class="grid-data">
        ...
        <div class="grid-data-cell">
            <div class="product-item">
                ...
                <div>
                    <a href="javascript:void(0);" onclick="viewProduct({{ $product->id }})" class="btn_quick-view ajax">Xem Nhanh</a>
                </div>
        ...
        function viewProduct(productId) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var addToCartUrl = "{{ Auth::check() ? route('cart.add', ['id' => ':id']) : 'javascript:void(0)' }}";
